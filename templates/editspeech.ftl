                ...
                <div id="edit-protocol" class="w-75 m-2" style="display: block;">
                    <form method="<#if isnew>PUT<#else>POST</#if>">
                        <div class="input-group m-2">
                            <span class="input-group-text"><#if isnew>Tagesordnungspunkt<#else>ID</#if></span>
                            <input name="inId" type="text" class="form-control" value="${id}" disabled>
                        </div>
                        <div class="input-group m-2">
                            <span class="input-group-text">Text</span>
                        </div>
                        <textarea class="w-100" style="min-height: 500px;" name="text"><#if !isnew>${speech}</#if></textarea>
                        <div class="input-group m-2">
                            <span class="input-group-text">Redner-ID</span>
                            <input type="text" class="input-control" name="speakerId" <#if !isnew>value="${speakerId}"</#if> placeholder="D123" required>
                        </div>
                        <div class="input-group m-2">
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="editSpeech(this.parentNode.parentNode)">Speichern</button>
                        </div>
                        <div class="input-group m-2">
                            <button type="button" class="btn btn-sm btn-outline-danger" onclick="deleteSpeech(this.parentNode.parentNode)">Löschen</button>
                        </div>
                    </form>
                </div>
            </div>
