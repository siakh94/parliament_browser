    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper-vis" class="d-flex flex-column w-100">
            <div id="content">
                ...
                <!-- End of Topbar -->
                <div id="edit-agenda-item" class="w-50 m-2">
                    <form method="<#if isnew>PUT<#else>POST</#if>">
                        <div class="input-group m-2">
                            <span class="input-group-text"><#if isnew>Protokoll<#else>ID</#if></span>
                            <input type="text" class="form-control" value="${id}" name="inId" disabled>
                        </div>
                        <div class="input-group m-2">
                        ...
                        <#if !isnew>
                        <div class="input-group m-2">
                            <button type="button" class="btn btn-sm btn-success" onclick="window.location = '/edit/speech?agendaItemId=${id}'">Rede anhängen</button>
                        </div>
                        <div class="input-group m-2 dropdown">
                            <button type="button" class="btn btn-sm btn-danger dropdown-toggle" data-toggle="dropdown">Rede entfernen</button>
                            <div class="dropdown-menu">
                                <#list speeches as speech>
                                    <a type="button" class="dropdown-item" onclick="deleteSpeechFromAgenda('${speech.id}')">${speech.id} (${speech.speaker})</a>
                                </#list>
                            </div>
                        </div>
                        </#if>
                        <div class="input-group m-2">
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="editAgendaItem(this.parentNode.parentNode)">Speichern</button>
                        </div>
                        <div class="input-group m-2">
                            <button type="button" class="btn btn-sm btn-outline-danger" onclick="deleteAgendaItem(this.parentNode.parentNode)">Löschen</button>
                        </div>
                    </form>
                </div>
            </div>
