            ...
            <div id="content">
                ...
                <div id="edit-protocol" class="w-75 m-2" style="display: block;">
                    <form method="<#if isnew>PUT<#else>POST</#if>">
                        ...
                        <div class="input-group m-2">
                            <span class="input-group-text">Template Typ</span>
                            <select class="custom-select" name="type">
                                <option value="protocol" <#if isnew || type == "protocol">selected</#if>>Protokoll</option>
                                <option value="agendaItem" <#if type == "agendaItem">selected</#if>>Tagesordnungspunkt</option>
                                <option value="speech" <#if type == "speech">selected</#if>>Rede</option>
                            </select>
                        </div>
                        <div class="input-group m-2">
                            <span class="input-group-text">TeX Template</span>
                        </div>
                        <textarea class="w-100" style="min-height: 500px;" name="raw"><#if !isnew>${raw}</#if></textarea>
                        <div class="input-group m-2">
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="editTemplate(this.parentNode.parentNode)">Speichern</button>
                        </div>
                        <div class="input-group m-2">
                            <button type="button" class="btn btn-sm btn-outline-danger" onclick="deleteTemplate(this.parentNode.parentNode)">Löschen</button>
                        </div>
                    </form>
                </div>
            </div>
