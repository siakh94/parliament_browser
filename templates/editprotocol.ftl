    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper-vis" class="d-flex flex-column w-100">
            <div id="content">
                ...
                <!-- End of Topbar -->
                <div id="edit-protocol" class="w-50 m-2" style="display: block;">
                    <form method="<#if isnew>PUT<#else>POST</#if>">
                        ...
                        <div class="input-group m-2">
                            ...
                            <input type="date" class="form-control" name="date" value="${dateformatted}">
                        </div>
                        <div class="input-group m-2">
                            <span class="input-group-text">Startzeit</span>
                            <input type="text" class="form-control" name="starttime" value="${starttime}">
                        </div>
                        <div class="input-group m-2">
                            <span class="input-group-text">Endzeit</span>
                        ...
                        <div class="input-group m-2">
                            ...
                            <input type="number" class="form-control" name="period" min="1" max="50" value=${period}>
                        </div>
                        <#if !isnew>
                        <div class="input-group m-2">
                            <button type="button" class="btn btn-sm btn-success" onclick="window.location = '/edit/agendaItem?protocolId=${id}'">Tagesordnungspunkt anhängen</button>
                        </div>
                        <div class="input-group m-2 dropdown">
                            <button type="button" class="btn btn-sm btn-danger dropdown-toggle" data-toggle="dropdown">Tagesordnungspunkt entfernen</button>
                            <div class="dropdown-menu">
                                <#list agendaitems as agendaitem>
                                    <a type="button" class="dropdown-item" onclick="deleteAgendaItemFromProtocol('${agendaitem.id}')">${agendaitem.id} (${agendaitem.title})</a>
                                </#list>
                            </div>
                        </div>
                        </#if>
                        <div class="input-group m-2">
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="editProtocol(this.parentNode.parentNode)">Speichern</button>
                        </div>
                        <div class="input-group m-2">
                            <button type="button" class="btn btn-sm btn-outline-danger" onclick="deleteProtocol(this.parentNode.parentNode)">Löschen</button>
                        </div>
                    </form>
                </div>
            </div>
