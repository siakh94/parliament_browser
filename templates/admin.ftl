    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper-vis" class="d-flex flex-column w-100">
            <div id="content">
                ...
                <!-- End of Topbar -->
                <div id="manage-user" class="w-50">
                    <h3>User bearbeiten</h3>
                    <#list users as k>
                        <form>
                            <div class="input-group m-2">
                                <input type="text" class="form-control" name="username" value="${k.username}" disabled>
                                <div class="input-group-append">
                                    <button type="button" onclick="editUser(this.parentNode.parentNode.parentNode)" type="button" class="btn btn-outline-primary">
                                        Speichern
                                    </button>
                                    <button type="button" onclick="deleteUser(this.parentNode.parentNode.parentNode)" type="button" class="btn btn-outline-danger">
                                        Löschen
                                    </button>
                                </div>
                            </div>
                            <div class="input-group m-2">
                                <#list ["admin", "protocol", "speech", "template"] as perm>
                                    <div class="form-check">
                                        <input class="form-check-input" name="${perm}" type="checkbox" <#if k[perm]>checked</#if>>
                    ...
                    <form>
                        <div class="input-group m-2">
                            ...
                            <div class="input-group-append">
                                <button type="button" onclick="createUser(this.parentNode.parentNode.parentNode)" type="button" class="btn btn-outline-success">
                                    Erstellen
                                </button>
                            </div>
                        </div>
                    ...
                    <h3>Legende</h3>
                    Checkbox 1: "Admin" features (User bearbeiten)<br>
                    Checkbox 2: "Protokoll" features<br>
                    Checkbox 3: "Rede" features<br>
                    Checkbox 4: "Template" features
                </div>
            </div>
        </div>
    </div>
